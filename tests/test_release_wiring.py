"""Release-level wiring checks for Home Assistant Astro Weather 12.4.10."""
import json
import sys
import tempfile
import unittest
...
class ReleaseWiringTests(unittest.TestCase):
    ...
    def test_release_config_and_docker_entrypoint(self):
        ...
        self.assertIn('version: "12.4.10"', config)
        ...
        self.assertEqual(core.APP_VERSION, "12.4.10")
    ...
    def test_v34_and_satellite_card_v8_install_is_self_contained(self):
        ...
        with tempfile.TemporaryDirectory() as config_dir:
            ...
            for name in (
                ...
                "astro-satellite-card-v7.js", "astro-satellite-card-v8.js",
            ...
            self.assertEqual(manifest["backend_version"], "12.4.10")
