...
After adding or changing a resource, refresh the browser. If the card still does not load, use Ctrl+F5 or raise the query suffix, for example `?v=17` to `?v=18`.
